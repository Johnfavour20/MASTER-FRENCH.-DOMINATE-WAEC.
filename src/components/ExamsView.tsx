...
import { 
  ...
  Flag, Eye, Wifi, UserCheck, Sparkles, BookOpen, Lock, Trophy, Play
} from "lucide-react";
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-blue-100/80 text-xs md:text-sm font-medium max-w-xl leading-relaxed">
                      L'épreuve majeure hebdomadaire de La Plume. Conçu pour recréer l'exacte pression du hall d'examen réel du WAEC. Préparez-vous à valider vos compétences dans des conditions optimales de concentration.
                    </p>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-5 text-center min-w-[200px] shrink-0">
                    <p className="text-[10px] text-blue-200 font-mono uppercase font-black tracking-wider">Prochain Examen Officiel</p>
                    <p className="text-xs font-black text-[#FFD214] mt-1.5 font-mono">{formatCountdown()}</p>
                    <p className="text-[10px] text-slate-400 mt-2">Vendredi à 10:00 (Heure du Nigeria)</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 space-y-6 shadow-xs relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-6 border-b border-slate-100">
                  <div className="space-y-1">
                    ...
                    <h2 className="font-display font-bold text-2xl text-[#002B5B]">Résultats de l'Examen — Semaine 2</h2>
                    <p className="text-slate-500 text-xs font-semibold">Session surveillée du Vendredi</p>
                  </div>
